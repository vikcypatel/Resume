...
const Hero = () => {
  return (
    <section id='home' className='lg:h-[80vh] md:h-[100vh] mt-4 flex items-center bg-primary lg:bg-cover lg:bg-center lg:bg-no-repeat py-32 lg:py-0 overflow-hidden'>
